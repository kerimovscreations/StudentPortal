...
@section('content')
    <md-content class="md-padding" style="text-align: center">
        ...
        <div layout="row" layout-align="center">
            <md-button class="md-raised md-primary" href="{{ url('register/student') }}">Student</md-button>
            <md-button class="md-raised md-primary" href="{{ url('register/teacher') }}">Teacher</md-button>
            <md-button class="md-raised md-primary" href="{{ url('register/mentor') }}">Mentor</md-button>
        </div>
    </md-content>
                ...
                <md-card flex-xs style="max-width: 400px; margin: 10px auto" ng-cloak>
                    <md-card-title>
                        <md-card-title-text layout="column" layout-align="center center">
                            <span class="md-headline" style="color: #2E4454">Registration for {{ session('userType') }}</span>
                        </md-card-title-text>
                    </md-card-title>
                    <md-card-content layout="column" layout-align="center">
                        <form role="form" method="POST" action="{{ url('/'.session('userType').'/register') }}">
                            {!! csrf_field() !!}
